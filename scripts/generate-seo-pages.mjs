...
<body>
  ...
  <header class="header"><div class="shell nav"><a class="brand" href="/" aria-label="HXLFAB home"><span class="brand-bars"><i></i><i></i><i></i></span><span>HXL<strong>FAB</strong></span></a><nav aria-label="Main navigation"><a href="/pcb-manufacturing/">PCB Manufacturing</a><a href="/#capabilities">Capabilities</a><a href="/#factory">Factory</a><a href="/#quality">Quality</a></nav><a class="button small" href="/#quote">Request a quote <span>↗</span></a></div></header>
  <main>
  ...
  <footer><div class="shell footer-grid"><div><a class="brand footer-brand" href="/"><span class="brand-bars"><i></i><i></i><i></i></span><span>HXL<strong>FAB</strong></span></a><p>${common.company}<br>A manufacturing subsidiary of Shenzhen Hengxinlong.</p></div><div><span>Production base</span><p>Jinjiping Industrial Park, Xinping Town,<br>Lipu City, Guilin, Guangxi, China</p></div><div><span>Capabilities</span><p><a href="/multilayer-pcb/">Multilayer PCB</a><br><a href="/hdi-pcb/">HDI PCB</a><br><a href="/high-frequency-pcb/">High-frequency PCB</a></p></div><div><span>Contact</span><p><a href="mailto:${common.email}">${common.email}</a><br><a href="tel:+8613823663114">${common.phone}</a></p></div></div><div class="shell footer-bottom"><span>© 2026 HXLFAB. All rights reserved.</span><span>Technical data subject to engineering confirmation.</span></div></footer>
</body>
</html>`;
}
